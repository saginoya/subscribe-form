  ...
  <LyCont>
    <BlContsUnit>
      ...
      <BlFaq>
        ...
        <BlFaqA>
          <p>連絡事項などにつきましては、備考欄にご記入をお願いいたします。</p>
          <p>（請求先・送付先を別途ご指定など）</p>
        </BlFaqA>
      </BlFaq>
      <BlCta title="お問い合わせ">
        ...
        <BlFieldset>
          ...
          >
            <BlCardUnit>
              <BlCard>
                <p>
                  <ElInputSelection type="checkbox" id="magazines[]" value="ht">
                    週刊&nbsp;包装タイムス
                  </ElInputSelection>
                </p>
                <p>
              ...
              <BlCard>
                <p>
                  <ElInputSelection type="checkbox" id="magazines[]" value="fp">
                    月刊&nbsp;食品包装
                  </ElInputSelection>
                </p>
                <p>
              ...
              <BlCard>
                <p>
                  <ElInputSelection type="checkbox" id="magazines[]" value="jk">
                    週刊&nbsp;循環経済新聞
                  </ElInputSelection>
                </p>
                <p>
